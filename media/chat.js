...
const steeringSetting = document.createElement('div'); steeringSetting.className = 'setting'; steeringSetting.innerHTML = `<button id="steeringMode" class="icon-only" title="Steering mode"></button><div id="steeringMenu" class="setting-menu"><button data-steering-mode="steer">${routeSvg}Steer</button><button data-steering-mode="queue">${queueSvg}Queue</button></div>`; submit.before(steeringSetting);
